...
- **Customer:** Can manage their cart, place orders, view their order history
- **Admin:** Full access to all endpoints including product and category management
...
```bash
curl "http://localhost:3000/api/products?search=phone&minPrice=100&maxPrice=1000&page=1&limit=10"
```
